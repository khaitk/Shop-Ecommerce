                        ...
                        <table>
                            ...
                            <tr>
                                <td class="shoping__cart__item">
                                    <img src="../images/products/{{$cart->images}}" alt="" width="150px">
                                    <h5>{{$cart->name}}</h5>
                                </td>
                                <td class="shoping__cart__price">
                                    {{number_format($cart->original_price)}} đ
                                </td>
                                ...
                                <td class="shoping__cart__total">
                                    {{number_format($cart->original_price * $cart->quantity)}} đ
                                </td>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5>Cart Total</h5>
                        <ul>
                            <li>Subtotal <span>{{number_format($total)}} đ</span></li>
