                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-8">
                            ...
                            @foreach($address as $add)
                                <b class="text-danger">Address {{$i++}}: </b>
                                <h4>{{$add->name}}</h4>
                                <p>
                                    <i class="glyphicon glyphicon-envelope"></i>{{$add->email}}
                                    <br />
                                    <i class="glyphicon glyphicon-envelope"></i>{{$add->phone}}
                                    <br />
                                    <i class="glyphicon glyphicon-envelope"></i>{{$add->address}}
                                    <br />
                                </p>
                            @endforeach
                        </div>
