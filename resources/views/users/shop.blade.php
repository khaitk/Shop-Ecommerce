                            ...
                            <div class="product__discount__slider owl-carousel">
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg" data-setbg="../images/products/{{$product->images}}">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <div class="product__item__price">{{number_format($product->promotion_price)}} đ<span>{{number_format($product->original_price)}} đ</span></div>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
